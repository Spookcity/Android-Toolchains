...
enum opt_code
{
  ...
  OPT_fuse_ld_mcld = 1074,                   /* -fuse-ld=mcld */
  ...
  OPT_mabi_ = 1151,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1152,             /* -mabort-on-noreturn */
  OPT_mandroid = 1153,                       /* -mandroid */
  OPT_mapcs = 1154,                          /* -mapcs */
  OPT_mapcs_frame = 1155,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1156,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1157,              /* -mapcs-stack-check */
  OPT_march_ = 1158,                         /* -march= */
  OPT_marm = 1159,                           /* -marm */
  OPT_masm_syntax_unified = 1160,            /* -masm-syntax-unified */
  OPT_mbig_endian = 1161,                    /* -mbig-endian */
  OPT_mbionic = 1162,                        /* -mbionic */
  OPT_mcallee_super_interworking = 1163,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1164,     /* -mcaller-super-interworking */
  OPT_mcmse = 1165,                          /* -mcmse */
  OPT_mcpu_ = 1166,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1167,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1168,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1169,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1170,                  /* -mfp16-format= */
  OPT_mfpu_ = 1171,                          /* -mfpu= */
  OPT_mglibc = 1172,                         /* -mglibc */
  /* OPT_mhard_float = 1173, */              /* -mhard-float */
  OPT_mlittle_endian = 1174,                 /* -mlittle-endian */
  OPT_mlong_calls = 1175,                    /* -mlong-calls */
  OPT_mmusl = 1176,                          /* -mmusl */
  OPT_mneon_for_64bits = 1177,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1178,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1179,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1180,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1181,               /* -mprint-tune-info */
  OPT_mpure_code = 1182,                     /* -mpure-code */
  OPT_mrestrict_it = 1183,                   /* -mrestrict-it */
  OPT_msched_prolog = 1184,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1185,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1186,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1187, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1188,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1189,                         /* -mthumb */
  OPT_mthumb_interwork = 1190,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1191,                  /* -mtls-dialect= */
  OPT_mtp_ = 1192,                           /* -mtp= */
  OPT_mtpcs_frame = 1193,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1194,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1195,                         /* -mtune= */
  OPT_muclibc = 1196,                        /* -muclibc */
  OPT_munaligned_access = 1197,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1198,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1199,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1200,              /* -mword-relocations */
  OPT_n = 1201,                              /* -n */
  OPT_no_canonical_prefixes = 1202,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1203,              /* -no-integrated-cpp */
  OPT_no_pie = 1204,                         /* -no-pie */
  OPT_nocpp = 1205,                          /* -nocpp */
  OPT_nodefaultlibs = 1206,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1207,                   /* -nostartfiles */
  OPT_nostdinc = 1208,                       /* -nostdinc */
  OPT_nostdinc__ = 1209,                     /* -nostdinc++ */
  OPT_nostdlib = 1210,                       /* -nostdlib */
  OPT_o = 1211,                              /* -o */
  OPT_p = 1212,                              /* -p */
  OPT_pass_exit_codes = 1213,                /* -pass-exit-codes */
  /* OPT_pedantic = 1214, */                 /* -pedantic */
  OPT_pedantic_errors = 1215,                /* -pedantic-errors */
  OPT_pg = 1216,                             /* -pg */
  OPT_pie = 1217,                            /* -pie */
  OPT_pipe = 1218,                           /* -pipe */
  OPT_posix = 1219,                          /* -posix */
  OPT_print_file_name_ = 1220,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1221,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1222,          /* -print-multi-directory */
  OPT_print_multi_lib = 1223,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1224,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1225,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1226,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1227,               /* -print-prog-name= */
  OPT_print_search_dirs = 1228,              /* -print-search-dirs */
  OPT_print_sysroot = 1229,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1230,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1231,                        /* -profile */
  OPT_pthread = 1232,                        /* -pthread */
  OPT_quiet = 1233,                          /* -quiet */
  OPT_r = 1234,                              /* -r */
  OPT_rdynamic = 1235,                       /* -rdynamic */
  OPT_remap = 1236,                          /* -remap */
  OPT_s = 1237,                              /* -s */
  OPT_save_temps = 1238,                     /* -save-temps */
  OPT_save_temps_ = 1239,                    /* -save-temps= */
  OPT_shared = 1240,                         /* -shared */
  OPT_shared_libgcc = 1241,                  /* -shared-libgcc */
  /* OPT_specs = 1242, */                    /* -specs */
  OPT_specs_ = 1243,                         /* -specs= */
  OPT_static = 1244,                         /* -static */
  OPT_static_libasan = 1245,                 /* -static-libasan */
  OPT_static_libgcc = 1246,                  /* -static-libgcc */
  OPT_static_libgfortran = 1247,             /* -static-libgfortran */
  OPT_static_libgo = 1248,                   /* -static-libgo */
  OPT_static_liblsan = 1249,                 /* -static-liblsan */
  OPT_static_libmpx = 1250,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1251,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1252,               /* -static-libstdc++ */
  OPT_static_libtsan = 1253,                 /* -static-libtsan */
  OPT_static_libubsan = 1254,                /* -static-libubsan */
  /* OPT_std_c__03 = 1255, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1256, */                /* -std=c++0x */
  OPT_std_c__11 = 1257,                      /* -std=c++11 */
  OPT_std_c__14 = 1258,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1259, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1260, */                /* -std=c++1y */
  OPT_std_c__1z = 1261,                      /* -std=c++1z */
  OPT_std_c__98 = 1262,                      /* -std=c++98 */
  OPT_std_c11 = 1263,                        /* -std=c11 */
  /* OPT_std_c1x = 1264, */                  /* -std=c1x */
  /* OPT_std_c89 = 1265, */                  /* -std=c89 */
  OPT_std_c90 = 1266,                        /* -std=c90 */
  OPT_std_c99 = 1267,                        /* -std=c99 */
  /* OPT_std_c9x = 1268, */                  /* -std=c9x */
  OPT_std_f2003 = 1269,                      /* -std=f2003 */
  OPT_std_f2008 = 1270,                      /* -std=f2008 */
  OPT_std_f2008ts = 1271,                    /* -std=f2008ts */
  OPT_std_f95 = 1272,                        /* -std=f95 */
  OPT_std_gnu = 1273,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1274, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1275, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1276,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1277,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1278, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1279, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1280,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1281,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1282,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1283, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1284, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1285,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1286,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1287, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1288, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1289,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1290, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1291, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1292, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1293,                     /* -std=legacy */
  OPT_symbolic = 1294,                       /* -symbolic */
  OPT_t = 1295,                              /* -t */
  OPT_time = 1296,                           /* -time */
  OPT_time_ = 1297,                          /* -time= */
  OPT_tno_android_cc = 1298,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1299,                 /* -tno-android-ld */
  OPT_traditional = 1300,                    /* -traditional */
  OPT_traditional_cpp = 1301,                /* -traditional-cpp */
  OPT_trigraphs = 1302,                      /* -trigraphs */
  OPT_u = 1303,                              /* -u */
  OPT_undef = 1304,                          /* -undef */
  OPT_v = 1305,                              /* -v */
  OPT_version = 1306,                        /* -version */
  OPT_w = 1307,                              /* -w */
  OPT_wrapper = 1308,                        /* -wrapper */
  OPT_x = 1309,                              /* -x */
  OPT_z = 1310,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
