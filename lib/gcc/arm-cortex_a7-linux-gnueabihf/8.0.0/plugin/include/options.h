...
enum opt_code
{
  ...
  OPT_Wextra_semi = 224,                     /* -Wextra-semi */
  ...
  /* OPT_Wnormalized = 304, */               /* -Wnormalized */
  OPT_Wnormalized_ = 305,                    /* -Wnormalized= */
  OPT_Wnull_dereference = 306,               /* -Wnull-dereference */
  OPT_Wodr = 307,                            /* -Wodr */
  OPT_Wold_style_cast = 308,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 309,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 310,           /* -Wold-style-definition */
  OPT_Wopenmp_simd = 311,                    /* -Wopenmp-simd */
  OPT_Woverflow = 312,                       /* -Woverflow */
  OPT_Woverlength_strings = 313,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 314,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 315,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 316,     /* -Woverride-init-side-effects */
  OPT_Wp_ = 317,                             /* -Wp, */
  OPT_Wpacked = 318,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 319,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 320,                         /* -Wpadded */
  OPT_Wparentheses = 321,                    /* -Wparentheses */
  OPT_Wpedantic = 322,                       /* -Wpedantic */
  /* OPT_Wplacement_new = 323, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 324,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 325,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 326,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 327,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 328,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 329,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 330,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 331,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 332,                       /* -Wprotocol */
  OPT_Wpsabi = 333,                          /* -Wpsabi */
  OPT_Wreal_q_constant = 334,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 335,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 336,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 337,                /* -Wredundant-decls */
  OPT_Wregister = 338,                       /* -Wregister */
  OPT_Wreorder = 339,                        /* -Wreorder */
  OPT_Wrestrict = 340,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 341,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 342,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 343,           /* -Wscalar-storage-order */
  OPT_Wselector = 344,                       /* -Wselector */
  OPT_Wsequence_point = 345,                 /* -Wsequence-point */
  OPT_Wshadow = 346,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 347, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 348,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 349, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 350,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 351, */            /* -Wshadow=global */
  OPT_Wshadow_local = 352,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 353,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 354,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 355,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 356, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 357,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 358,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 359,                /* -Wsign-conversion */
  OPT_Wsign_promo = 360,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 361,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 362,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_memaccess = 363,       /* -Wsizeof-pointer-memaccess */
  ...
  /* OPT_Wstringop_overflow = 373, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 374,             /* -Wstringop-overflow= */
  OPT_Wsubobject_linkage = 375,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_const = 376,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 377,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_noreturn = 378,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 379,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 380,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 381,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 382,               /* -Wsuggest-override */
  ...
  OPT_Wswitch_unreachable = 388,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 389,                      /* -Wsync-nand */
  OPT_Wsynth = 390,                          /* -Wsynth */
  OPT_Wsystem_headers = 391,                 /* -Wsystem-headers */
  OPT_Wtabs = 392,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 393,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 394,           /* -Wtautological-compare */
  OPT_Wtemplates = 395,                      /* -Wtemplates */
  OPT_Wterminate = 396,                      /* -Wterminate */
  OPT_Wtraditional = 397,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 398,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 399,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 400,                      /* -Wtrigraphs */
  OPT_Wtype_limits = 401,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 402,            /* -Wundeclared-selector */
  OPT_Wundef = 403,                          /* -Wundef */
  OPT_Wundefined_do_loop = 404,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 405,                      /* -Wunderflow */
  OPT_Wuninitialized = 406,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 407,                /* -Wunknown-pragmas */
  ...
  /* OPT_Wunused_const_variable = 414, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 415,         /* -Wunused-const-variable= */
  ...
  OPT_Wunused_value = 423,                   /* -Wunused-value */
  OPT_Wunused_variable = 424,                /* -Wunused-variable */
  OPT_Wuse_without_only = 425,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 426,                   /* -Wuseless-cast */
  OPT_Wvarargs = 427,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 428,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 429,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 430,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 431,            /* -Wvirtual-move-assign */
  OPT_Wvla = 432,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 433,               /* -Wvla-larger-than= */
  OPT_Wvolatile_register_var = 434,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 435,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 436,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 437,                       /* -Wzerotrip */
  OPT_Xassembler = 438,                      /* -Xassembler */
  OPT_Xlinker = 439,                         /* -Xlinker */
  OPT_Xpreprocessor = 440,                   /* -Xpreprocessor */
  OPT_Z = 441,                               /* -Z */
  OPT_ansi = 442,                            /* -ansi */
  OPT_aux_info = 443,                        /* -aux-info */
  /* OPT_aux_info_ = 444, */                 /* -aux-info= */
  OPT_auxbase = 445,                         /* -auxbase */
  OPT_auxbase_strip = 446,                   /* -auxbase-strip */
  OPT_c = 447,                               /* -c */
  OPT_coverage = 448,                        /* -coverage */
  OPT_cpp = 449,                             /* -cpp */
  OPT_cpp_ = 450,                            /* -cpp= */
  OPT_d = 451,                               /* -d */
  OPT_dumpbase = 452,                        /* -dumpbase */
  OPT_dumpdir = 453,                         /* -dumpdir */
  OPT_dumpfullversion = 454,                 /* -dumpfullversion */
  OPT_dumpmachine = 455,                     /* -dumpmachine */
  OPT_dumpspecs = 456,                       /* -dumpspecs */
  OPT_dumpversion = 457,                     /* -dumpversion */
  OPT_e = 458,                               /* -e */
  OPT_export_dynamic = 459,                  /* -export-dynamic */
  OPT_fPIC = 460,                            /* -fPIC */
  OPT_fPIE = 461,                            /* -fPIE */
  OPT_fRTS_ = 462,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 463,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 464,                   /* -fabi-version= */
  OPT_faccess_control = 465,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 466,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 467,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 468,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 469,                  /* -falign-commons */
  OPT_falign_functions = 470,                /* -falign-functions */
  OPT_falign_functions_ = 471,               /* -falign-functions= */
  OPT_falign_jumps = 472,                    /* -falign-jumps */
  OPT_falign_jumps_ = 473,                   /* -falign-jumps= */
  OPT_falign_labels = 474,                   /* -falign-labels */
  OPT_falign_labels_ = 475,                  /* -falign-labels= */
  OPT_falign_loops = 476,                    /* -falign-loops */
  OPT_falign_loops_ = 477,                   /* -falign-loops= */
  /* OPT_faligned_new = 478, */              /* -faligned-new */
  OPT_faligned_new_ = 479,                   /* -faligned-new= */
  OPT_fall_intrinsics = 480,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 481, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 482,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 483,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 484, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 485, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 486, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 487, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 488, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 489,            /* -fasan-shadow-offset= */
  OPT_fasm = 490,                            /* -fasm */
  OPT_fassociative_math = 491,               /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 492,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 493,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 494,                   /* -fauto-profile */
  OPT_fauto_profile_ = 495,                  /* -fauto-profile= */
  OPT_fautomatic = 496,                      /* -fautomatic */
  OPT_fbackslash = 497,                      /* -fbackslash */
  OPT_fbacktrace = 498,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 499,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 500,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 501,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 502,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 503,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 504,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 505,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 506,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 507,                        /* -fbuiltin */
  OPT_fbuiltin_ = 508,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 509,                 /* -fbuiltin-printf */
  OPT_fcall_saved_ = 510,                    /* -fcall-saved- */
  OPT_fcall_used_ = 511,                     /* -fcall-used- */
  OPT_fcaller_saves = 512,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 513,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 514,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 515,                /* -fcheck-data-deps */
  OPT_fcheck_new = 516,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 517,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 518,                         /* -fcheck= */
  OPT_fchecking = 519,                       /* -fchecking */
  OPT_fchecking_ = 520,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 521,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 522,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 523,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 524,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 525,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 526,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 527,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 528,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 529, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 530,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 531,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 532,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 533, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 534,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 535,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 536,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 537,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 538,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 539,                       /* -fcilkplus */
  OPT_fcoarray_ = 540,                       /* -fcoarray= */
  OPT_fcode_hoisting = 541,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 542,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 543,                         /* -fcommon */
  OPT_fcompare_debug = 544,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 545,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 546,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 547,                   /* -fcompare-elim */
  OPT_fconcepts = 548,                       /* -fconcepts */
  OPT_fcond_mismatch = 549,                  /* -fcond-mismatch */
  OPT_fconserve_space = 550,                 /* -fconserve-space */
  OPT_fconserve_stack = 551,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 552,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 553,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 554,          /* -fconstexpr-loop-limit= */
  OPT_fconvert_ = 555,                       /* -fconvert= */
  OPT_fcprop_registers = 556,                /* -fcprop-registers */
  OPT_fcray_pointer = 557,                   /* -fcray-pointer */
  OPT_fcrossjumping = 558,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 559,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 560, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 561,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 562,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 563,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 564,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 565,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 566,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 567,                       /* -fdbg-cnt= */
  OPT_fdce = 568,                            /* -fdce */
  OPT_fdebug_cpp = 569,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 570,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 571,            /* -fdebug-types-section */
  OPT_fdec = 572,                            /* -fdec */
  OPT_fdec_intrinsic_ints = 573,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 574,                       /* -fdec-math */
  OPT_fdec_static = 575,                     /* -fdec-static */
  OPT_fdec_structure = 576,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 577,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 578,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 579,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 580, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 581,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 582,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 583,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 584,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 585,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 586,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 587,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 588,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 589,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 590, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 591,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_generate_patch = 592,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_parseable_fixits = 593,   /* -fdiagnostics-parseable-fixits */
  ...
  OPT_fdollar_ok = 599,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 600,         /* -fdollars-in-identifiers */
  OPT_fdse = 601,                            /* -fdse */
  OPT_fdump_ = 602,                          /* -fdump- */
  OPT_fdump_ada_spec = 603,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 604,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 605, */                /* -fdump-core */
  OPT_fdump_final_insns = 606,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 607,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 608,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 609,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 610,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 611,        /* -fdump-internal-locations */
  ...
  OPT_femit_struct_debug_baseonly = 624,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 625,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 626,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 627,                        /* -fenable- */
  OPT_fenforce_eh_specs = 628,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 629, */           /* -fenum-int-equiv */
  OPT_fexceptions = 630,                     /* -fexceptions */
  OPT_fexcess_precision_ = 631,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 632,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 633,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 634,           /* -fext-numeric-literals */
  ...
  OPT_ffinite_math_only = 642,               /* -ffinite-math-only */
  OPT_ffixed_ = 643,                         /* -ffixed- */
  OPT_ffixed_form = 644,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 645,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 646,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 647,                    /* -ffloat-store */
  OPT_ffor_scope = 648,                      /* -ffor-scope */
  /* OPT_fforce_addr = 649, */               /* -fforce-addr */
  OPT_fforward_propagate = 650,              /* -fforward-propagate */
  OPT_ffp_contract_ = 651,                   /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 652,         /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 653,                   /* -ffpe-summary= */
  ...
  OPT_fgimple = 668,                         /* -fgimple */
  OPT_fgnat_encodings_ = 669,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 670,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 671,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 672,                         /* -fgnu-tm */
  OPT_fgnu_unique = 673,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 674,                   /* -fgnu89-inline */
  OPT_fgo_c_header_ = 675,                   /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 676,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 677,           /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 678,           /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 679,                /* -fgo-debug-escape */
  OPT_fgo_dump_ = 680,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 681,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 682,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 683,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 684,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 685,                       /* -fgraphite */
  OPT_fgraphite_identity = 686,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 687,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 688, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 689, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 690, */                     /* -fhelp */
  /* OPT_fhelp_ = 691, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 692,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 693, */                /* -fhonor-std */
  OPT_fhosted = 694,                         /* -fhosted */
  /* OPT_fhuge_objects = 695, */             /* -fhuge-objects */
  OPT_fident = 696,                          /* -fident */
  OPT_fif_conversion = 697,                  /* -fif-conversion */
  OPT_fif_conversion2 = 698,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 699,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 700,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 701,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 702,             /* -fimplicit-templates */
  OPT_findirect_inlining = 703,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 704,         /* -finhibit-size-directive */
  OPT_finit_character_ = 705,                /* -finit-character= */
  OPT_finit_derived = 706,                   /* -finit-derived */
  OPT_finit_integer_ = 707,                  /* -finit-integer= */
  OPT_finit_local_zero = 708,                /* -finit-local-zero */
  OPT_finit_logical_ = 709,                  /* -finit-logical= */
  OPT_finit_real_ = 710,                     /* -finit-real= */
  OPT_finline = 711,                         /* -finline */
  OPT_finline_atomics = 712,                 /* -finline-atomics */
  OPT_finline_functions = 713,               /* -finline-functions */
  OPT_finline_functions_called_once = 714,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 715, */            /* -finline-limit- */
  OPT_finline_limit_ = 716,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 717,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 718,         /* -finline-small-functions */
  OPT_finput_charset_ = 719,                 /* -finput-charset= */
  OPT_finstrument_functions = 720,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 721,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 722,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 723,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 724,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 725,        /* -fintrinsic-modules-path= */
  OPT_fipa_bit_cp = 726,                     /* -fipa-bit-cp */
  OPT_fipa_cp = 727,                         /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 728, */         /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 729,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 730,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 731,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 732,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 733, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 734,                    /* -fipa-profile */
  OPT_fipa_pta = 735,                        /* -fipa-pta */
  OPT_fipa_pure_const = 736,                 /* -fipa-pure-const */
  OPT_fipa_ra = 737,                         /* -fipa-ra */
  OPT_fipa_reference = 738,                  /* -fipa-reference */
  ...
  OPT_fuse_ld_mcld = 1075,                   /* -fuse-ld=mcld */
  ...
  OPT_mabi_ = 1152,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1153,             /* -mabort-on-noreturn */
  OPT_mandroid = 1154,                       /* -mandroid */
  OPT_mapcs = 1155,                          /* -mapcs */
  OPT_mapcs_frame = 1156,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1157,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1158,              /* -mapcs-stack-check */
  OPT_march_ = 1159,                         /* -march= */
  OPT_marm = 1160,                           /* -marm */
  OPT_masm_syntax_unified = 1161,            /* -masm-syntax-unified */
  OPT_mbig_endian = 1162,                    /* -mbig-endian */
  OPT_mbionic = 1163,                        /* -mbionic */
  OPT_mcallee_super_interworking = 1164,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1165,     /* -mcaller-super-interworking */
  OPT_mcmse = 1166,                          /* -mcmse */
  OPT_mcpu_ = 1167,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1168,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1169,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1170,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1171,                  /* -mfp16-format= */
  OPT_mfpu_ = 1172,                          /* -mfpu= */
  OPT_mglibc = 1173,                         /* -mglibc */
  /* OPT_mhard_float = 1174, */              /* -mhard-float */
  OPT_mlittle_endian = 1175,                 /* -mlittle-endian */
  OPT_mlong_calls = 1176,                    /* -mlong-calls */
  OPT_mmusl = 1177,                          /* -mmusl */
  OPT_mneon_for_64bits = 1178,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1179,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1180,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1181,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1182,               /* -mprint-tune-info */
  OPT_mpure_code = 1183,                     /* -mpure-code */
  OPT_mrestrict_it = 1184,                   /* -mrestrict-it */
  OPT_msched_prolog = 1185,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1186,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1187,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1188, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1189,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1190,                         /* -mthumb */
  OPT_mthumb_interwork = 1191,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1192,                  /* -mtls-dialect= */
  OPT_mtp_ = 1193,                           /* -mtp= */
  OPT_mtpcs_frame = 1194,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1195,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1196,                         /* -mtune= */
  OPT_muclibc = 1197,                        /* -muclibc */
  OPT_munaligned_access = 1198,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1199,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1200,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1201,              /* -mword-relocations */
  OPT_n = 1202,                              /* -n */
  OPT_no_canonical_prefixes = 1203,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1204,              /* -no-integrated-cpp */
  OPT_no_pie = 1205,                         /* -no-pie */
  OPT_nocpp = 1206,                          /* -nocpp */
  OPT_nodefaultlibs = 1207,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1208,                   /* -nostartfiles */
  OPT_nostdinc = 1209,                       /* -nostdinc */
  OPT_nostdinc__ = 1210,                     /* -nostdinc++ */
  OPT_nostdlib = 1211,                       /* -nostdlib */
  OPT_o = 1212,                              /* -o */
  OPT_p = 1213,                              /* -p */
  OPT_pass_exit_codes = 1214,                /* -pass-exit-codes */
  /* OPT_pedantic = 1215, */                 /* -pedantic */
  OPT_pedantic_errors = 1216,                /* -pedantic-errors */
  OPT_pg = 1217,                             /* -pg */
  OPT_pie = 1218,                            /* -pie */
  OPT_pipe = 1219,                           /* -pipe */
  OPT_posix = 1220,                          /* -posix */
  OPT_print_file_name_ = 1221,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1222,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1223,          /* -print-multi-directory */
  OPT_print_multi_lib = 1224,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1225,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1226,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1227,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1228,               /* -print-prog-name= */
  OPT_print_search_dirs = 1229,              /* -print-search-dirs */
  OPT_print_sysroot = 1230,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1231,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1232,                        /* -profile */
  OPT_pthread = 1233,                        /* -pthread */
  OPT_quiet = 1234,                          /* -quiet */
  OPT_r = 1235,                              /* -r */
  OPT_rdynamic = 1236,                       /* -rdynamic */
  OPT_remap = 1237,                          /* -remap */
  OPT_s = 1238,                              /* -s */
  OPT_save_temps = 1239,                     /* -save-temps */
  OPT_save_temps_ = 1240,                    /* -save-temps= */
  OPT_shared = 1241,                         /* -shared */
  OPT_shared_libgcc = 1242,                  /* -shared-libgcc */
  /* OPT_specs = 1243, */                    /* -specs */
  OPT_specs_ = 1244,                         /* -specs= */
  OPT_static = 1245,                         /* -static */
  OPT_static_libasan = 1246,                 /* -static-libasan */
  OPT_static_libgcc = 1247,                  /* -static-libgcc */
  OPT_static_libgfortran = 1248,             /* -static-libgfortran */
  OPT_static_libgo = 1249,                   /* -static-libgo */
  OPT_static_liblsan = 1250,                 /* -static-liblsan */
  OPT_static_libmpx = 1251,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1252,          /* -static-libmpxwrappers */
  ...
  /* OPT_std_c__17 = 1260, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1261, */                /* -std=c++1y */
  OPT_std_c__1z = 1262,                      /* -std=c++1z */
  OPT_std_c__98 = 1263,                      /* -std=c++98 */
  OPT_std_c11 = 1264,                        /* -std=c11 */
  /* OPT_std_c1x = 1265, */                  /* -std=c1x */
  /* OPT_std_c89 = 1266, */                  /* -std=c89 */
  OPT_std_c90 = 1267,                        /* -std=c90 */
  OPT_std_c99 = 1268,                        /* -std=c99 */
  /* OPT_std_c9x = 1269, */                  /* -std=c9x */
  OPT_std_f2003 = 1270,                      /* -std=f2003 */
  OPT_std_f2008 = 1271,                      /* -std=f2008 */
  OPT_std_f2008ts = 1272,                    /* -std=f2008ts */
  OPT_std_f95 = 1273,                        /* -std=f95 */
  OPT_std_gnu = 1274,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1275, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1276, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1277,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1278,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1279, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1280, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1281,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1282,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1283,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1284, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1285, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1286,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1287,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1288, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1289, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1290,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1291, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1292, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1293, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1294,                     /* -std=legacy */
  OPT_symbolic = 1295,                       /* -symbolic */
  OPT_t = 1296,                              /* -t */
  OPT_time = 1297,                           /* -time */
  OPT_time_ = 1298,                          /* -time= */
  OPT_tno_android_cc = 1299,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1300,                 /* -tno-android-ld */
  OPT_traditional = 1301,                    /* -traditional */
  OPT_traditional_cpp = 1302,                /* -traditional-cpp */
  OPT_trigraphs = 1303,                      /* -trigraphs */
  OPT_u = 1304,                              /* -u */
  OPT_undef = 1305,                          /* -undef */
  OPT_v = 1306,                              /* -v */
  OPT_version = 1307,                        /* -version */
  OPT_w = 1308,                              /* -w */
  OPT_wrapper = 1309,                        /* -wrapper */
  OPT_x = 1310,                              /* -x */
  OPT_z = 1311,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
