...
enum opt_code
{
  ...
  OPT_mabi_ = 1182,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1183,             /* -mabort-on-noreturn */
  OPT_mandroid = 1184,                       /* -mandroid */
  OPT_mapcs = 1185,                          /* -mapcs */
  OPT_mapcs_float = 1186,                    /* -mapcs-float */
  OPT_mapcs_frame = 1187,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1188,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1189,              /* -mapcs-stack-check */
  OPT_march_ = 1190,                         /* -march= */
  OPT_marm = 1191,                           /* -marm */
  OPT_masm_syntax_unified = 1192,            /* -masm-syntax-unified */
  OPT_mbig_endian = 1193,                    /* -mbig-endian */
  OPT_mbionic = 1194,                        /* -mbionic */
  OPT_mcallee_super_interworking = 1195,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1196,     /* -mcaller-super-interworking */
  OPT_mcpu_ = 1197,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1198,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1199,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1200,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1201,                  /* -mfp16-format= */
  OPT_mfpu_ = 1202,                          /* -mfpu= */
  OPT_mglibc = 1203,                         /* -mglibc */
  /* OPT_mhard_float = 1204, */              /* -mhard-float */
  OPT_mlittle_endian = 1205,                 /* -mlittle-endian */
  OPT_mlong_calls = 1206,                    /* -mlong-calls */
  OPT_mmusl = 1207,                          /* -mmusl */
  OPT_mneon_for_64bits = 1208,               /* -mneon-for-64bits */
  OPT_mnew_generic_costs = 1209,             /* -mnew-generic-costs */
  OPT_mold_rtx_costs = 1210,                 /* -mold-rtx-costs */
  OPT_mpic_data_is_text_relative = 1211,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1212,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1213,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1214,               /* -mprint-tune-info */
  OPT_mrestrict_it = 1215,                   /* -mrestrict-it */
  OPT_msched_prolog = 1216,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1217,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1218,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1219, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1220,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1221,                         /* -mthumb */
  OPT_mthumb_interwork = 1222,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1223,                  /* -mtls-dialect= */
  OPT_mtp_ = 1224,                           /* -mtp= */
  OPT_mtpcs_frame = 1225,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1226,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1227,                         /* -mtune= */
  OPT_muclibc = 1228,                        /* -muclibc */
  OPT_munaligned_access = 1229,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1230,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1231,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1232,              /* -mword-relocations */
  OPT_n = 1233,                              /* -n */
  OPT_no_canonical_prefixes = 1234,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1235,              /* -no-integrated-cpp */
  OPT_no_pie = 1236,                         /* -no-pie */
  OPT_nocpp = 1237,                          /* -nocpp */
  OPT_nodefaultlibs = 1238,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1239,                   /* -nostartfiles */
  OPT_nostdinc = 1240,                       /* -nostdinc */
  OPT_nostdinc__ = 1241,                     /* -nostdinc++ */
  OPT_nostdlib = 1242,                       /* -nostdlib */
  OPT_o = 1243,                              /* -o */
  OPT_p = 1244,                              /* -p */
  OPT_pass_exit_codes = 1245,                /* -pass-exit-codes */
  /* OPT_pedantic = 1246, */                 /* -pedantic */
  OPT_pedantic_errors = 1247,                /* -pedantic-errors */
  OPT_pg = 1248,                             /* -pg */
  OPT_pie = 1249,                            /* -pie */
  OPT_pipe = 1250,                           /* -pipe */
  OPT_posix = 1251,                          /* -posix */
  OPT_print_file_name_ = 1252,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1253,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1254,          /* -print-multi-directory */
  OPT_print_multi_lib = 1255,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1256,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1257,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1258,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1259,               /* -print-prog-name= */
  OPT_print_search_dirs = 1260,              /* -print-search-dirs */
  OPT_print_sysroot = 1261,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1262,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1263,                        /* -profile */
  OPT_pthread = 1264,                        /* -pthread */
  OPT_quiet = 1265,                          /* -quiet */
  OPT_r = 1266,                              /* -r */
  OPT_rdynamic = 1267,                       /* -rdynamic */
  OPT_remap = 1268,                          /* -remap */
  OPT_s = 1269,                              /* -s */
  OPT_s_bc_abi = 1270,                       /* -s-bc-abi */
  OPT_save_temps = 1271,                     /* -save-temps */
  OPT_save_temps_ = 1272,                    /* -save-temps= */
  OPT_shared = 1273,                         /* -shared */
  OPT_shared_libgcc = 1274,                  /* -shared-libgcc */
  /* OPT_specs = 1275, */                    /* -specs */
  OPT_specs_ = 1276,                         /* -specs= */
  OPT_static = 1277,                         /* -static */
  OPT_static_libasan = 1278,                 /* -static-libasan */
  OPT_static_libgcc = 1279,                  /* -static-libgcc */
  OPT_static_libgcj = 1280,                  /* -static-libgcj */
  ...
  /* OPT_std_c__03 = 1289, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1290, */                /* -std=c++0x */
  OPT_std_c__11 = 1291,                      /* -std=c++11 */
  OPT_std_c__14 = 1292,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1293, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1294, */                /* -std=c++1y */
  OPT_std_c__1z = 1295,                      /* -std=c++1z */
  OPT_std_c__98 = 1296,                      /* -std=c++98 */
  OPT_std_c11 = 1297,                        /* -std=c11 */
  /* OPT_std_c1x = 1298, */                  /* -std=c1x */
  /* OPT_std_c89 = 1299, */                  /* -std=c89 */
  OPT_std_c90 = 1300,                        /* -std=c90 */
  OPT_std_c99 = 1301,                        /* -std=c99 */
  /* OPT_std_c9x = 1302, */                  /* -std=c9x */
  OPT_std_f2003 = 1303,                      /* -std=f2003 */
  OPT_std_f2008 = 1304,                      /* -std=f2008 */
  OPT_std_f2008ts = 1305,                    /* -std=f2008ts */
  OPT_std_f95 = 1306,                        /* -std=f95 */
  OPT_std_gnu = 1307,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1308, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1309, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1310,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1311,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1312, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1313, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1314,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1315,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1316,                      /* -std=gnu11 */
  ...
  OPT_std_legacy = 1327,                     /* -std=legacy */
  OPT_symbolic = 1328,                       /* -symbolic */
  OPT_t = 1329,                              /* -t */
  OPT_time = 1330,                           /* -time */
  OPT_time_ = 1331,                          /* -time= */
  OPT_tno_android_cc = 1332,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1333,                 /* -tno-android-ld */
